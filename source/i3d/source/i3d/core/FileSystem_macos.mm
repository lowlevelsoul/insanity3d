...
namespace i3d {
    ...
    //=========================================================================================================================================
    void FileSystemMacos::FileClose( File * file ) {
        fclose( ((FileStd*)file)->m_file );
        FreeFile( ((FileStd*)file) );
    }

    //=========================================================================================================================================
    bool FileSystemMacos::GetCurrentDirectory( stl::String::type & pathOut ) {
    ...
    //=========================================================================================================================================
    bool FileSystemMacos::MakeFullPath(stl::String::type & pathOut, const char* pathIn ) {
        switch( pathIn[0] ) {
            ...
            case MOUNT_ASSET_PREFIX: {
                std::lock_guard<std::mutex> lock( m_mutex );
                JoinPath( pathOut, m_mountAssets.c_str(), pathIn+1);
                break;
            }
    ...
    //=========================================================================================================================================
    char FileSystemMacos::GetPlatformSeparator() {
        return '/';
    }

    //=========================================================================================================================================
    char FileSystemMacos::GetOtherSeparator() {
        return '\\';
    }

    //=========================================================================================================================================
    bool FileSystemMacos::DoesFileExist( const char* path) {
    ...
    //=========================================================================================================================================
    bool FileSystemMacos::DoesFolderExist( const char* path) {
    ...
    //=========================================================================================================================================
    bool FileSystemMacos::CreateFolder( const char* path, bool createIntermediate ) {
    ...
    //=========================================================================================================================================
    bool FileSystemMacos::EnumeratePathConents( const char * path, PathEnumeratorFunc enumFunc, void * context, const char * ext ) {
        NSString * extStr = nil;
        if (ext != nullptr) {
    ...
    //======================================================================================================================
    bool FileSystemMacos::GetApplicationPath( stl::String::type & pathOut ) {
    ...
    //======================================================================================================================
    bool FileSystemMacos::GetModifiedTimestamp(uint64_t& timeStamp, const char * filePath) {
