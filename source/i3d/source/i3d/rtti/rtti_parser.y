...
#include <stdlib.h>
#include <stdio.h>
#include "xe/util/ParseType.h"
#include "xe/rtti/RttiLoader.h"
#include "xe/core/FileSystem.h"
...
#define YYSTYPE xe::RttiParseItem
...
object: KW_OBJECT lit_string
    ...
    '}' 
    { 
        $$.SetLiteralInt( rttiparse::loader->GetObjectIndex() );   
...
assignment: assign_scalar | assign_scalar_simple | assign_array_simple;
...
lit_number: 
    lit_int { 
        $$.m_type =xe:: RttiParseItem::TYPE_LITERAL;
        $$.m_litType =xe:: RttiParseItem::LIT_FLOAT;
        $$.m_value.m_litFloat = (float) $1.m_value.m_litInt;
        $1.Clear();
    }
    | lit_float {
        $$.m_type =xe:: RttiParseItem::TYPE_LITERAL;
        $$.m_litType =xe:: RttiParseItem::LIT_FLOAT;
        $$.m_value.m_litFloat = $1.m_value.m_litFloat;
        $1.Clear();
    }
    ;
...
namespace rttiparse {
    ...
    bool ParseRttiFile( xe::File* file, xe::RttiLoader* loader ) {
